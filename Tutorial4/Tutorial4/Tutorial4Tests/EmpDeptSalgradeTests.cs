...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnAllSalesmen()
    {
        ...
        //Assert czyli wyświetlenie wartości jakie powinny być z naszego testu 
    ...
    public void ShouldReturnDept30EmpsOrderedBySalaryDesc()
    {
        ...
        //### moje 
        result = emps.Where(e => e.DeptNo == 30).OrderByDescending(s => s.Sal).ToList();
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        result = emps.Where(e => depts.Where(d => d.Loc == "CHICAGO")
            .Select(d => d.DeptNo)
            .Contains(e.DeptNo))
            .ToList();
...
// wszystkie odpowiedzi z LINQ ponieważ na wykładzie było że konstrukcja ta jest bardzo podobna w innych językach
// i warto ją umieć 